...
const navigation = [
  ...
  { name: 'Theo dõi', href: '/follow', current: false },
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 p-2 fixed w-full top-0">
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                          ...
                          {user ? (<img className="h-8 w-8 rounded-full" src={user?.photoURL} alt="" />) : (<img className="h-8 w-8 rounded-full" src="" alt="Not Login" />)}
